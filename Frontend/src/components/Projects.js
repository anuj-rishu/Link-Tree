    ...
    >
      ...
      {projects.map((project, index) => (
        ...
        >
          ...
          >
            <img
              className="w-full h-64  text-justify object-cover rounded-md  "
              src={project.thumbnail}
              alt={project.title}
            />
            <div className=" pl-2 pr-2 py-3 bg-gray-800 mt-4 rounded-md ">
              <div className="font-bold text-md mb-2 text-white bg-indigo-500 inline-block p-1 pr-4 pl-3 rounded whitespace-normal">
                {project.title}
              </div>
