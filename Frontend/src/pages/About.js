...
const About = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-20 sm:mt-auto mb-auto bg-transparent px-4 sm:px-0 lg:px-16 xl:px-32">
      ...
      >
        I'm Anuj Tiwari, 2nd-year IT student with a focus on backend
        development. Explore my projects showcasing database management,
        server-side scripting, and more. Join me on my journey as I hone my
        skills and contribute to the world of web development... !!
      </motion.p>
    </div>
  );
};
